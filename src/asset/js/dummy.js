...
export const projectData = [
    ...
    },
    {
        ...
        description : [ 
            ...
            {des : '순수 React로 개발을 진행하였지만, 현재 타입스크립트와 Next.js에 대한 공부도 계획중에 있기 때문에 추가적인 프레임워크를 사용해서 이 사이트를 조금 더 최적화 시키는 계획을 세우게 되었습니다. '},
            {des : '리액트와 관련해서도 늘 성능적인 부분을 생각하려고 노력하고 있고, 그에 대한 이해가 부족하다고 생각되어 항상 공부를 병행하고 있습니다.'},
        ],
